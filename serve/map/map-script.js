...
map.on('mouseenter', 'cells-layer', async (e) => {
    if(map.getZoom() > 15.2 || map.getZoom() < 12){
        return
    }
...
map.on('mouseenter', 'cityview-cells-layer', async (e) => {
    if(map.getZoom() < 15.2){
        return
    }
    // Call API for advanced tower tooltip infos
...
map.on('mouseenter', 'cityview-unitless-towers', async (e) => {
...
map.on('mouseenter', 'cityview-small-cells-polygons', (e) => {
